...
public class SimpleTestUI {
	 ...
	 public void aFastTest() {
        ...
        //driver.findElement(By.cssSelector(buttonCheckYourRate)).click();
        //WebElement element = driver.findElement(By.cssSelector(buttonCheckYourRate));
//         JavascriptExecutor executor = (JavascriptExecutor)driver;
//         executor.executeScript("arguments[0].click();", element);
//         executor.executeScript("arguments[0].click();", element);
        //((JavascriptExecutor) driver).executeScript("arguments[0].click();", driver.findElement(By.cssSelector(buttonCheckYourRate)));
